    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="left">
                    <h3 class="box-title">Adicionar Bio Link</h3>
                </div>
                <div class="right">
            ...
            <form action="<?= adminUrl('bio-links/add'); ?>" method="post">
                <?= csrf_field(); ?>
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="bio-link-preview">
                            <a href="#" id="preview-button" class="btn" style="display: block; margin: 10px 0; text-decoration: none; border-radius: 25px; padding: 12px 20px; text-align: center; font-weight: 600;">
                                <i id="preview-icon"></i>
                                <span id="preview-title">Título do Link</span>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-footer">
                    <button type="submit" class="btn btn-primary">
                        <i class="fa fa-save"></i>&nbsp;&nbsp;Salvar Link
                    </button>
                    <a href="<?= adminUrl('bio-links'); ?>" class="btn btn-default">
