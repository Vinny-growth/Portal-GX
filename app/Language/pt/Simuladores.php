...
return [
    ...
    'srs_kpi_multiplo'      => 'Sua reserva chega a',
    'srs_kpi_multiplo_sub'  => 'vezes tudo o que você aporta',
    ...
    'srs_report_toolbar' => 'Relatório liberado · pronto para você',
    'srs_print_btn'      => '↓ Baixar relatório (PDF)',
    'srs_cover_kicker'   => 'Planejamento de Proteção & Sucessão',
    'srs_cover_title'    => 'Relatório de<br>Diagnóstico Patrimonial',
    'srs_cover_meta'     => 'Preparado para',
    'srs_rp_label_01'    => '01 · Seu diagnóstico',
    'srs_rp_label_02'    => '02 · Proteção recomendada',
    'srs_rp_label_03'    => '03 · Seu plano GX',
    'srs_th_cobertura'   => 'Cobertura',
    'srs_th_premio'      => 'Prêmio mensal',
    'srs_rp_label_04'    => '04 · Vida produtiva, patrimônio e reserva',
    'srs_th_momento'     => 'Momento',
    'srs_total_aportado' => 'Total aportado',
    'srs_rp_label_05'    => '05 · Blindagem sucessória',
    'srs_rp_cta_title'   => 'O próximo passo é desenhar isso com um especialista GX.',
    'srs_rp_bullet_1'    => 'Validação do capital ideal para o seu momento e objetivo.',
    'srs_rp_bullet_2'    => 'Estruturação da apólice resgatável com a melhor seguradora.',
    'srs_rp_bullet_3'    => 'Otimização tributária e de liquidez para a sucessão.',
    'srs_rp_bullet_4'    => 'Acompanhamento do plano ao longo dos anos, sem custo de consultoria.',
    'srs_rp_wa_btn'      => 'Falar com um especialista agora',
    'srs_report_foot'    => 'Documento gerado pelo simulador {brand}. Os valores são <strong>projeções</strong> baseadas em IPCA estimado (5,5% a.a.), nos fatores de resgate da apólice e nas informações fornecidas; <strong>não constituem garantia</strong> de rentabilidade, oferta ou proposta de contratação. Custos de sucessão (ITCMD/inventário) são estimativas de referência e variam conforme a legislação estadual e o caso concreto. Condições, carências e coberturas seguem o regulamento do produto e a regulação da SUSEP. Prêmios incluem IOF de 0,38%.',

    // modal de lead
    'srs_modal_close'    => 'Fechar',
    'srs_modal_title'    => 'Veja o valor exato',
    'srs_modal_sub'      => 'Liberamos na hora o aporte mensal recomendado e a sua reserva projetada em Reais. Um planejador da GX pode validar o plano com você.',
    'srs_lbl_nome'       => 'Nome',
