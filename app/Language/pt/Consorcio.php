...
return [
    ...
    // ===================================================================
    // 4b-6 — microcopy do JS (dicionário L + fill; {x}=placeholder runtime).
    // Só USER-FACING; identificadores de CRM/analytics ficam literais no JS.
    // ===================================================================

    // scenarioMeta (label/kicker reusam chaves estáticas quando idênticos)
    'js_sm_compare_hook'    => 'Veja se o consórcio reduz sua parcela e o custo total comparado ao financiamento.',
    'js_sm_compare_ph'      => 'Ex.: tenho R$ 90 mil de entrada e quero saber se consórcio sai mais barato que financiamento.',
    'js_sm_planned_label'   => 'Compra planejada de imóvel',
    'js_sm_planned_kicker'  => 'Compra planejada',
    'js_sm_planned_hook'    => 'Descubra se seu ritmo mensal sustenta a contemplação no prazo que você precisa.',
    'js_sm_planned_ph'      => 'Ex.: quero comprar em até 18 meses, consigo guardar R$ 3.500/mês além da parcela.',
    'js_sm_investor_label'  => 'Investimento para revenda',
    'js_sm_investor_hook'   => 'Calcule se a margem de revenda compensa o capital investido na operação.',
    'js_sm_investor_ph'     => 'Ex.: tenho R$ 120 mil para lance e busco margem de 18% na revenda após contemplação.',

    // updateWhatsAppLink
    'js_wa_copy_label'   => 'Mensagem pronta para iniciar a conversa sobre {label}.',
    'js_wa_copy_default' => 'Mensagem pronta para iniciar a conversa com o especialista.',

    // ---- compareScenario ----
    'js_c_head_pos' => 'O consórcio preserva mais caixa ao longo da operação do que o financiamento usado como referência.',
    'js_c_head_neg' => 'Com esta configuração, o custo total fica pressionado. A escolha do grupo e da estratégia de lance passa a ser decisiva.',
    'js_c_ins1'     => 'Usando a entrada como lance, a pressão mensal indicativa do consórcio fica em {v} frente ao financiamento comparado.',
    'js_c_ins_low'  => 'Sua entrada representa apenas {p} da carta. Para contemplar no prazo-alvo, a seleção do grupo precisa ser mais criteriosa.',
    'js_c_ins_ok'   => 'A entrada cobre cerca de {p} da carta. Isso já permite trabalhar contemplação com estratégia, não apenas com sorteio.',
    'js_c_ins3'     => 'Até o mês {m}, o capital mobilizado estimado pelo consórcio ficaria em {v}.',
    'js_c_body'     => 'Esta leitura compara o financiamento tradicional com a estrutura de consórcio considerando sua entrada como lance próprio e o custo-base da cota.',
    'js_c_m1l' => 'Parcela do consórcio',
    'js_c_m1c' => 'Base indicativa da cota antes de ajustes finos por grupo.',
    'js_c_m2l' => 'Parcela do financiamento',
    'js_c_m2c' => 'PMT estimada com taxa e prazo informados.',
    'js_c_m3l' => 'Diferença mensal',
    'js_c_m3c' => 'Folga mensal favorável ao consórcio quando positiva.',
    'js_c_m4l' => 'Diferença total',
    'js_c_m4c' => 'Comparação entre desembolso total do financiamento e da estratégia de consórcio.',
    'js_c_b1l' => 'Entrada/lance',
    'js_c_b1c' => 'Equivale a {p} do valor da carta.',
    'js_c_b2l' => 'Custo-base da cota',
    'js_c_b2c' => 'Carta + taxas consideradas na estrutura: {p}.',
    'js_c_lead' => 'Olá! Vim pelo simulador de consórcio da {brand} e quero validar uma comparação entre consórcio e financiamento. Minha simulação indica parcela do consórcio em {p} e diferença total em {d}.',

    // ---- plannedScenario ----
    'js_p_head_ok'    => 'Há base para montar uma compra planejada com esforço mensal controlado.',
    'js_p_head_over'  => 'O fluxo mensal projetado fica acima do teto informado. A estrutura precisa de ajuste antes de avançar.',
    'js_p_head_short' => 'O fluxo comporta a operação, mas a reserva para lance ainda está curta para a meta de contemplação informada.',
    'js_p_ins1'    => 'Até o mês {m}, sua reserva projetada para lance chegaria a {v}.',
    'js_p_ins2'    => 'O lance modelado neste cenário cobre aproximadamente {p} do valor corrigido do ativo até a contemplação.',
    'js_p_ins_pos' => 'Somando parcela e formação de reserva, ainda sobrariam {v} por mês dentro do orçamento informado.',
    'js_p_ins_neg' => 'Parcela e reserva juntas excedem seu orçamento confortável em {v} por mês.',
    'js_p_body'    => 'A leitura observa se a parcela, a formação de reserva e a correção esperada do ativo conversam com a data que você pretende comprar.',
    'js_p_m1l' => 'Parcela estimada',
    'js_p_m1c' => 'Base mensal da cota simulada.',
    'js_p_m2l' => 'Reserva até a meta',
    'js_p_m2c' => 'Caixa previsto para sustentar o lance no prazo-alvo.',
    'js_p_m3l' => 'Lance modelado',
    'js_p_m3c' => 'Faixa inicial de lance usando sua reserva projetada.',
    'js_p_m4l' => 'Folga mensal',
    'js_p_m4c' => 'Diferença entre teto confortável e compromisso mensal total.',
    'js_p_b1l' => 'Valor corrigido do ativo',
    'js_p_b1c' => 'Projeção considerando correção de {p} ao ano.',
    'js_p_b2l' => 'Compromisso mensal total',
    'js_p_b2c' => 'Parcela da cota mais reserva para lance.',
    'js_p_lead' => 'Olá! Vim pelo simulador de consórcio da {brand} e quero estruturar uma compra planejada com consórcio. Minha simulação indica reserva projetada de {v} até o mês {m} e folga mensal de {d}.',

    // ---- investorScenario ----
    'js_i_head_strong' => 'A tese mostra margem líquida positiva sobre o capital mobilizado, mas precisa de validação fina de grupo e saída.',
    'js_i_head_tight'  => 'Há ganho potencial, mas a margem sobre o capital travado ainda está apertada para uma tese confortável.',
    'js_i_head_neg'    => 'Nesta configuração, a margem esperada não cobre custos de transação e carregamento.',
    'js_i_ins1'    => 'Até a revenda, o capital mobilizado estimado nesta estrutura seria de {v}.',
    'js_i_ins2'    => 'A margem líquida indicativa após custos fica em {v}, equivalente a {p} sobre o capital mobilizado.',
    'js_i_ins_low' => 'O lance próprio informado cobre apenas {p} da carta. Para uma tese de revenda, isso exige seleção ainda mais criteriosa de grupos.',
    'js_i_ins_ok'  => 'O lance próprio cobre cerca de {p} da carta, nível que já permite discutir timing com mais seriedade.',
    'js_i_body'    => 'Aqui o foco é entender se o ganho de revenda compensa o tempo, o capital imobilizado e os atritos de saída da operação.',
    'js_i_m2l' => 'Capital mobilizado',
    'js_i_m2c' => 'Lance próprio mais parcelas até a revenda.',
    'js_i_m3l' => 'Margem líquida',
    'js_i_m3c' => 'Margem após custos de saída e carregamento.',
    'js_i_m4l' => 'ROI indicativo',
    'js_i_m4c' => 'Retorno estimado sobre o capital mobilizado.',
    'js_i_b1l' => 'Alavancagem da tese',
    'js_i_b1c' => 'Relação entre valor da carta e capital próprio mobilizado até a venda.',
    'js_i_b2l' => 'Custo de carregamento',
    'js_i_b2c' => 'Custo acumulado em {m} meses após contemplação.',
    'js_i_lead' => 'Olá! Vim pelo simulador de consórcio da {brand} e quero validar uma tese de consórcio para revenda. Minha simulação mostra capital mobilizado de {v} e margem líquida estimada de {d}.',

    // ---- status / handlers / mini-sim / quick / exit ----
    'js_enviando'      => 'Enviando...',
    'js_parse_err'     => 'Não foi possível interpretar a resposta do servidor.',
    'js_send_err'      => 'Não foi possível enviar sua solicitação agora.',
    'js_lead_success'  => 'Recebemos sua simulação. Um especialista da {brand} vai cruzar grupos, lance e prazo para retornar com um plano de contemplação.',
    'js_sent'          => 'Solicitação enviada',
    'js_erro_enviar'   => 'Erro ao enviar.',
    'js_quick_success' => 'Recebemos seus dados! Um especialista entrará em contato em breve.',
    'js_enviado'       => 'Enviado!',
    'js_mini_result'   => 'Você pode economizar até {v} com consórcio',
    'js_exit_success'  => 'Recebemos seu WhatsApp! Entraremos em contato em breve.',
];
