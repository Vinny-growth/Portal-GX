...
if (!function_exists('trackMetaLead')) {
     ...
     */
    function trackMetaLead($email = null, $phone = null, $firstName = null, $lastName = null, $customData = [])
    {
        try {
            return metaConversions()->trackLead($email, $phone, $firstName, $lastName, $customData);
        } catch (Exception $e) {
...
if (!function_exists('trackMetaCompleteRegistration')) {
     ...
     */
    function trackMetaCompleteRegistration($email = null, $customData = [])
    {
        try {
            return metaConversions()->trackCompleteRegistration($email, $customData);
        } catch (Exception $e) {
...
if (!function_exists('trackMetaContact')) {
     ...
     */
    function trackMetaContact($email = null, $customData = [])
    {
        try {
            return metaConversions()->trackContact($email, $customData);
        } catch (Exception $e) {
